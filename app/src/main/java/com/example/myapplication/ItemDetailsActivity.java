...
public class ItemDetailsActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        //info
        DatabaseReference infoReference = database.getReference("places").child(id);
        ...
        infoAndRatingReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    if (!hasElements){
                        displayRating.setText("Brak ocen");
                    }else
                    {
                    ...
                    displayRating.setText("Brak ocenaaaa");
                    displayInfo.setText(("Brak opisuaaa"));
                }
            }
